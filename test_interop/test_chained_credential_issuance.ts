...
keripy.init();
keripy.oobi.resolve(`https://weboftrust.github.io/oobi/${QVI_SCHEMA}`);
keripy.oobi.resolve(`https://weboftrust.github.io/oobi/${LE_SCHEMA}`);
keripy.oobi.resolve(`https://weboftrust.github.io/oobi/${ECR_SCHEMA}`);
...
const kerijs_oobi = `http://localhost:5642/oobi/${jsState.id}/witness`;
