  ...
  describe("handleMessage()", () => {
    ...
    describe("/fwd", () => {
      test("should store the inner evt message", async () => {
        ...
        assert.strictEqual(results[0].body.t, inner.body.t);
        assert.strictEqual(results[0].body.d, inner.body.d);
      });
    ...
    describe("mbx query", () => {
      ...
      test("should return messages from the given offset", async () => {
        ...
        assert.strictEqual(fromOffset[0].body.d, msg2.body.d);
        assert.strictEqual(fromOffset[1].body.d, msg3.body.d);
      });
