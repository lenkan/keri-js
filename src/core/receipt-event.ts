...
import { isTransferable, type KeyEventBody } from "./key-event.ts";
import { collectSignatures, type Signature, type Signer } from "./sign.ts";
...
export function applyReceipt(
  ...
  wigs.splice(0, wigs.length, ...unique(wigs));
