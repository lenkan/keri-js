...
import { Attachments, cesr } from "#keri/cesr";
...
describe(basename(import.meta.url), () => {
  ...
  describe("rotate", () => {
    test("should create rotation event", async () => {
      const controller = createController();
      const icp = await controller.incept();
      const data = { test: "data" };
    ...
    test("should rotate after interaction", async () => {
      const controller = createController();
      const icp = await controller.incept();
    ...
    test("should set key to pre-committed next key", async () => {
      const controller = createController();
      const icp = await controller.incept();
  ...
  describe("credential", () => {
    ...
    test("should create credential with all fields", async () => {
      const controller = createController();
    ...
    test("should create and issue credential", async () => {
      const controller = createController();
      const aid = await controller.incept();
      const registry = await controller.createRegistry(aid.id);
      const credential = await controller.createCredential({
    ...
    test("should create chained credential", async () => {
      const controller = createController();
  ...
  describe("endpoint", () => {
    ...
    test("should throw when selected role has no location", () => {
    ...
    test("should throw when no end role is found", () => {
      const controller = createController();
